...
\begin{tikzpicture}
  ...
  \node (C) at (4,0) {${\color{green}\CIRCLE}$};
  \node (D) at (1,-2) {${\color{green}\CIRCLE}$};
...
% Green arrows
\draw [->, green] (0) to [out=90, in=160, looseness=8] (0);
\draw [<->, green] (0) to [out=40, in=140] (1);
...
% Green arrow
\draw [->, green] (x1) to [out=320, in=220] (x2);
