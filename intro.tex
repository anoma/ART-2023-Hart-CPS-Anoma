...
We can note that this instance has three variables, $x_1$, $x_2$, and $x_3$. 2-SAT is a tractable CSP, meaning that we can always efficiently calculate if a solution exists, and what it is if it does. 

\begin{remark}
    When we describe something as "efficient" to solve, we always mean that is can be solved in polynomial time.
\end{remark}
